...
if(isset($_POST['sub']))
{
  ...
  else
  {
      ...
      else
      {
        ...
        echo "<script> alert ('User Added Successfully'); location.replace('admin.php')</script> ";
            
        }
        else
        {
         echo "<script> alert ('User Not Added '); location.replace('admin.php')</script> ";
        }
   ...
   <br>
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
         ...
         <div class="card">
            <div class="card-body">
              <br>
              <div class="card-title text-center"><h3><i class="zmdi zmdi-accounts-add"></i> Add User</h3></div><br>
            ...
            <form method="post" enctype="multipart/form-data">
                     ...
                     <form method="POST">
			           ...
			           <div class="position-relative has-icon-right">
				              <input type="text" class="form-control input-shadow" placeholder="Enter Username" name="username" required="required">
                   ...
                   E-mail
                      ...
                      <div class="form-group">
			                <div class="position-relative has-icon-right">
                         <input type="mail" name="usermail" placeholder="Enter E-mail " class="form-control input-shadow" required="required">
                         <div class="form-control-position">
                ...
                minlength="8" name="userpassword" placeholder="Enter Password " class="form-control" required="required" id="id_password" autocomplete="current-password">
                <div class="form-control-position">
                <i class="far fa-eye" id="togglePassword" style="margin-left: -30px; cursor: pointer;"></i>
                  ...
                  <form method="POST">
                      <div class="form-group">
			                <div class="position-relative has-icon-right">
                   <input type="Password"  maxlength="15"
                minlength="3" name="cuserpassword" placeholder="Enter Password " class="form-control" required="required">
                <div class="form-control-position">
                <i class="icon-lock"></i>
                  </div>
                  </div>
...
<script src="assets/js/app-script.js"></script>
  ...
  const showAlert = e => {
    ...
    return alert("Sorry, Mr Kottu Says You Can't View or Copy Our Source Codes !!!");
  }
