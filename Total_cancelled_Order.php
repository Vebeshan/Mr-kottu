...
<div class="clearfix"></div>
  ...
  <center>
      ...
      <div class="col-lg-12">
             <div class="card">
             <div class="card-body">
                  <h2 class="card-title" style="font-size:26px;"><b><i class="fas fa-utensils"></i> Total Cancel Order Details</b></h2>
...
$order_sql="SELECT * FROM order_cancel WHERE status='1' order by date DESC ";
