...
if(isset($_POST['print']))
{
    ...
    $delivery_product=$_POST['delivery_product'];
    $delivery_price=$_POST['delivery_price'];
    $delivery_qty=$_POST['delivery_qty'];
    $delivery_total=$_POST['delivery_tot'];
    
    $insert=mysqli_query($con,"INSERT INTO report_info(Date,Name,Product_Info,price,qty,Total,Date) VALUES('$delivery_name','$delivery_product','$delivery_price','$delivery_qty','$delivery_time')");
}
