...
if(isset($_GET['did'])){
   ...
   if($delete_query){
      echo "<script> alert('Review Deleted Successfully...'); location.replace('reveiw.php'); </script>";
   }else{
       echo "<script> alert('Review Not Deleted...'); location.replace('reveiw.php');</script>";
   };
};
...
if (mysqli_num_rows($res) > 0) {
    ...
    ?>
               ...
               <tr>
                            ...
                            <td><?= $star; ?></td>
                   <td>
<a <?php echo 'href="reveiw.php?did=' . $id . ' "'; ?> class="btn btn-md btn-danger" onclick="return confirm('Are You Want To Delete This review ?');"><i class="fas fa-trash"></i> Delete</a>
                   </td>
		        		</tr>
