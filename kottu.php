...
if($available==0 )
{
    echo "<script> alert('Sorry Today Our Resturent Closed You Canot Buy Anything Only View Our Food Menu & Our Website We will Opean Our Resturent Soon...');</script> ";
...
<div class="container">
        ...
        <div class="row">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="menu-flters">
              ...
              <a href="kottu.php"><li class="filter-active">Kottu</li></a>
   ...
   <?php 
      include 'connection.php';
      $select_products = mysqli_query($con,"SELECT * FROM products WHERE Type='Kottu' ORDER BY(DATE) DESC");
