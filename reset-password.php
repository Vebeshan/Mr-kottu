...
if(isset($_POST["reset"]))
{
  $otp_verification = $_POST['otp'];
    ...
    $html = '<html><head></head><body><div style="background: linear-gradient(80deg, #000428,#004e92); color: skyblue; text-align: center; padding: 10px; border-radius: 15px;">Your Verification Code:';
    $html .= '<h2> '.$verification_code.' </h2></div> </body>';
        ...
        //email verify
    $sql="UPDATE admin SET verification_code = '$verification_code',verification_at =NOW() WHERE Email='$email' " ;
		...
		<div class="card-body">
		 <div class="card-content p-2">
		  <div class="card-title text-uppercase pb-2">Reset Password</div>
		    <p class="pb-2">Please enter your email address. You will sent a OTP Number to Reset the password </p>
		    <form method="POST">
			  ...
			  <button type="Submit" class="btn btn-light btn-block mt-3" name="reset">Submit</button>
			 </form>
		   </div>
		  </div>
