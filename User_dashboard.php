      ...
      <div class="row row-group m-0">
          <div class="col-12 col-lg-6 col-xl-4 border-light">
              <div class="card-body">
                ...
                <h5 class="text-white mb-0">Total Foods  <i class="fas fa-utensils"></i> <span class="float-right"><?php echo $cucount ?> <i class="zmdi zmdi-long-arrow-up"></i></span></h5>
              </div>
          </div>
          ...
          <div class="col-12 col-lg-6 col-xl-4 border-light">
              <div class="card-body">
                ...
                <h5 class="text-white mb-0">Avilable Foods  <i class="fas fa-utensils"></i> <span class="float-right"><?php echo $pcount ?> <i class="zmdi zmdi-long-arrow-up"></i></span></h5>
              </div>
          </div>
          ...
          <div class="col-12 col-lg-6 col-xl-4 border-light">
              <div class="card-body">
                ...
                <h5 class="text-white mb-0">Special  Menus  <i class="fas fa-utensils"></i> <span class="float-right"><?php echo $cucount ?> <i class="zmdi zmdi-long-arrow-up"></i></span></h5>
              </div>
          </div>
      </div>
  </div>
      ...
      <div class="row row-group m-0">
          <div class="col-12 col-lg-6 col-xl-4 border-light">
              <div class="card-body">
                ...
                <h5 class="text-white mb-0">Total Customers <i class="fas fa-user-friends"></i><span class="float-right"><?php echo $cucount ?> <i class="zmdi zmdi-long-arrow-up"></i></span></h5>
              </div>
          </div>
          ...
          <div class="col-12 col-lg-6 col-xl-4 border-light">
              <div class="card-body">
                ...
                <h5 class="text-white mb-0">Messages <i class="fas fa-envelope"></i><span class="float-right"><?php echo $cucount ?> <i class="zmdi zmdi-long-arrow-up"></i></span></h5>
              </div>
          </div>
      </div>
  </div>
...
<!--3rd Row End-->
	...
	<div class="row">
	 <div class="col-12 col-lg-12">
	   <div class="card">
	     <div class="card-header"><i class="fas fa-utensils"></i> Recent Food Order Table
