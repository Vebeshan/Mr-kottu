	...
	<div class="card card-authentication1 mb-0">
		<div class="card-body">
		    ...
		    <form>
			  <div class="form-group">
			   ...
			   <div class="position-relative has-icon-right">
				  <input type="text" id="exampleInputEmailAddress" class="form-control input-shadow" placeholder="Enter New Password">
         ...
         <br>
			   ...
			   <div class="position-relative has-icon-right">
				  <input type="text" id="exampleInputEmailAddress" class="form-control input-shadow" placeholder="Re-enter New Password">
				  <div class="form-control-position">
            <i class="icon-lock"></i>
				  </div>
			   </div>
