...
<head>
  ...
  <title>Our Developers</title>
    ...
    <link href="assets_for_home/img/IMG-20230211-WA0016.jpg" rel="apple-touch-icon">
...
@import url('https://fonts.googleapis.com/css2?family=Montserrat:wght@300&family=Poppins:wght@200;300;400;500;600;700;800&display=swap');
...
<div class="container">
	<div class="row">
	<br>
	<h2 class="text-center" style="color: #ffc56e;"><b>Our Developers</b></h2>
		<div class="col-md-3">
    <hr>
            <a href="vebeshan.php">
    <div class="profile-card-2"><img src="assets_for_home/img/Developer_Profile/profile1-min.jpg" class="img img-responsive">
        <div class="profile-name" style="font-family: poppins;">J Vebeshan</div>
...
<div class="container">
    ...
    <hr>
            <a href="lukshan.php">
    <div class="profile-card-2"><img src="assets_for_home/img/Developer_Profile/profile2-min.jpg" class="img img-responsive" class="img img-responsive">
        <div class="profile-name" style="font-family: poppins;">Tj Lukshan</div>
        <div class="profile-username"></div>
        <div class="profile-icons"><a href="#"><i class="fa fa-facebook"></i></a><a href="#"><i class="fa fa-twitter"></i></a><a href="#"><i class="fa fa-linkedin"></i></a></div>
    </div>
            </a>
...
<div class="container">
    ...
    <hr>
            <a href="vaishu.php">
    <div class="profile-card-2"><img src="assets_for_home/img/Developer_Profile/profile3-min.jpg" class="img img-responsive" class="img img-responsive">
        <div class="profile-name" style="font-family: poppins;">G Vaishnavi</div>
        <div class="profile-username"></div>
        <div class="profile-icons"><a href="#"><i class="fa fa-facebook"></i></a><a href="#"><i class="fa fa-twitter"></i></a><a href="#"><i class="fa fa-linkedin"></i></a></div>
    </div>
            </a>
...
<div class="container">
    ...
    <hr>
            <a href="jeyanthi.php">
    <div class="profile-card-2"><img src="assets_for_home/img/Developer_Profile/profile4-min.JPG" class="img img-responsive" class="img img-responsive">
        <div class="profile-name" style="font-family: poppins;">Jeyanthi</div>
        <div class="profile-username"></div>
        <div class="profile-icons"><a href="#"><i class="fa fa-facebook"></i></a><a href="#"><i class="fa fa-twitter"></i></a><a href="#"><i class="fa fa-linkedin"></i></a></div>
    </div>
            </a>
