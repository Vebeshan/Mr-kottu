...
{
    $id=$_GET['did'];
    $del_query=mysqli_query($con,"DELETE FROM galary WHERE `galary`.`id` ='$id' ");
    ...
    {
        echo '<script> alert("Photo Not Deleted Successfully..."); </script>';
    }
}
?>
...
<div class="clearfix"></div>
  <div class="content-wrapper">
    <div class="container">
        <h3 class="text-center"><b>Gallery</b></h3>
        <br>
        ...
        <div class="form-group">
            <div class="row">
               ...
               <div class="col-md-4">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <input type="submit" name="uploadImageBtn" id="uploadImageBtn" value="Upload Images" class="btn btn-info">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        ...
        $i = 1;
        include "connection.php";
        $queryGetImg = "SELECT * FROM galary";
        ...
        if ($resultImg->num_rows > 0 ){
            ...
            <div class="card-body">
                    ...
                    <h4><span><?php echo $row->Name; ?></span> <span><?php echo $i;?></span></h4>
                    <img src="<?php echo 'updated_photo/'.$row->photo;?>" height="200" width="200">
                   <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdropLive">
            Launch static backdrop modal
          </button>
                    <a <?php echo 'href="file.php?did='.$ID.' "'; ?> class="btn btn-md btn-danger" onclick="return confirm('are your sure you want to delete this?');"><i class="fas fa-trash"></i>Delete</a>
                </div>
                </div>
        </div>
           <?php $i++;
