...
if(isset($_GET['did'])){
   $delete_id = $_GET['did'];
   $delete_query = mysqli_query($con, "DELETE FROM `special_menu` WHERE ID = $delete_id ") or die('query failed');
   if($delete_query){
...
<div class="clearfix"></div>
  ...
  <!--Start Dashboard Content-->
   <br>
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
         ...
         <div class="card" style="background-color:transparent;">
            <div class="card-body" style="background-color:transparent;">
              <br>
              <div class="card-title text-center"><h3><b><i class="fas fa-utensils"></i> Add Trending Menu</b></h3></div><br>
               
            <form method="post" enctype="multipart/form-data">
                
                
                   <p style="color:white;">Food Name</p>
                      <div class="form-group">
			                <div class="position-relative has-icon-right">
                     <select name="type" class="choices form-select form-control" required style="background-color:transparent;">
				...
				<?php }	?>
                                  ...
                                  <center>
                                  <input type="submit" name="ADD" value="Add" class="btn btn-info" > </center>
          ...
          include 'connection.php';
                 ...
                 echo'<section id="slider" class="pt-5">
                     <div class="container">
                     <h3 class="text-center"><b>Trending Menus</b></h3><div class="slider">'  ;
    ...
    <center>
  <a <?php echo 'href="menu.php?did='.$id.' "'; ?> class="btn btn-md btn-danger text-center" onclick="return confirm('are your sure you want to delete this?');"><i class="fas fa-trash"></i> Delete</a> </center>
                            </div>
