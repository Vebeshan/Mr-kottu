...
if(isset($_POST['sub']))
{
    ...
    $insert=mysqli_query($con,"INSERT INTO faq(ID,Question,Answer) VALUES(null,'$ques','$ans')");
    
    if($insert)
    {
      echo "<script> alert('FAQ Inserted '); location.replace('home_page_setting.php'); </script>";
    }
}
        ...
        <div class="col-12">
            ...
            <div class="card-body">
                ...
                <label>Question</label>
                    <input type="text" name="ques" value="" required class="form-control" placeholder="Enter Your Question...">
                    <br>
                    <label>Answer</label>
                   <textarea name="ans" required class="form-control" placeholder="Enter Your Answer..."></textarea>
                    <br>
                    
                    <center>
                    <input type="submit" value="Save" name="sub" class="btn btn-primary text-center">
                    <input type="reset" value="Reset" class="btn btn-warning text-center">
                    </center>
                </form>
                </div>
