...
if (isset($_POST['update'])) {
	...
	$sql=" update review set Subject='$Subject', Message='$Messagae', Rating='$Rating' where ID=$id ";
	$res=mysqli_query($con,$sql);

	if($res)
	{
echo "<script> alert('Your Review Is Updated'); location.replace('customer_view_reviews.php'); </script> "; 

	}
	else
	{
echo "<script> alert('Your Review Not Updated'); location.replace('customer_view_reviews.php'); </script> "; 
	}
  mysqli_close($con);
}
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h3 class="card-title text-center"><b>Update Your Review</b></h3>
                  ...
                  <form class="forms-sample" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Username"
                             value="<?php echo $From_mail; ?>" required="required" name="To_mail" disabled>
                    </div>
...
<textarea maxlength="100" minlength="10" placeholder="Tell somthing About Service Or Product Quality..." class="form-control" name='Messagae' required><?php echo $Message; ?></textarea>
                    </div>
                      
                      <div class="form-group">
                        <label for="exampleInputUsername1" >Rating</label>
                      <select class="form-control" name="Rating" required>
                          <option value=""><?php echo $Rating; ?></option>
                    ...
                    <center>
                    <input type="submit" class="btn btn-primary mr-2" value="Update Review" name="update">
