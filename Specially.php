...
<div class="container">
        ...
        <div class="row">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="menu-flters">
              ...
              <a href="Specially.php"><li class="filter-active">Specialty</li></a>
            </ul>
          </div>
        </div>
   ...
   <?php 
      include 'connection.php';
      $select_products = mysqli_query($con,"SELECT * FROM products WHERE Type='Specialty' ORDER BY(DATE) DESC");
