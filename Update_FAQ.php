...
if(isset($_GET['uid']))
{
	...
	$sql="SELECT * from faq where ID='$did' ";
	$res=mysqli_query($con,$sql);
    
    $faq_row=mysqli_fetch_array($res);
...
if(isset($_POST['sub']))
{
    ...
    $insert=mysqli_query($con,"UPDATE faq SET Question='$ques',Answer='$ans' WHERE ID='$did' ");
    
    if($insert)
    {
      echo "<script> alert('FAQ Updated'); location.replace('home_page_setting.php'); </script>";
    }
}
?>
    ...
    <li class="nav-item dropdown-lg">
       ...
       <li class="dropdown-item user-details">
        <a href="Notification.php">
           <div class="media">
            <?php   
                  $customer_count=mysqli_query($con,"SELECT * from `notifications` where `status` = 'unread' order by `date` DESC LIMIT 10 ");
...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
        <br>
        <h3 class="text-center">Update FAQ</h3>
        <br>
        <div class="row">
        <div class="col-12">
            <div class="card">
            <div class="card-body">
                ...
                <label>Question</label>
                    <input type="text" name="ques" value="<?php echo  $faq_row['Question']; ?>" required class="form-control" placeholder="Enter Your Question...">
                    <br>
                    <label>Answer</label>
                   <textarea name="ans" required class="form-control" placeholder="Enter Your Answer...">
                    <?php echo $faq_row['Answer']; ?>
                    </textarea>
                    <br>
                    
                    <center><input type="submit" value="Update" name="sub" class="btn btn-primary text-center">
                    <input type="reset" value="Cancel"  class="btn btn-warning text-center">
                    </center>
                </form>
                </div>
