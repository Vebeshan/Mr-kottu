...
<div class="clearfix"></div>
  ...
  <!--Start Dashboard Content-->
   ...
   <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
              <div class="col-12">
              <br>
              <div class="text-center"><h3><i class="icon-magnifier"></i> Search Results</h3></div></div><br><br>
   <?php
...
if(isset($_POST['search']))
{
  ...
  $food_serach=mysqli_query($con,"SELECT * FROM products WHERE Product_Name LIKE '%$search_type%' OR Type LIKE '%$search_type%' ");

  if(mysqli_num_rows($food_serach)>0)
  {
    while($row=mysqli_fetch_assoc( $food_serach))
    { ?>
...
<?php
    ...
    echo '<center><h3 class="text-center"> Oops Results Not Found...</h3><center>';
}

?>
        <center><a href="product.php" class="btn btn-primary">Back To Products</a></center>
