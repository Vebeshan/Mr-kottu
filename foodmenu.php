...
<body style="background-color:#f5f5f5;">
   ...
   <header id="header" class="site-navbar mt-3 d-flex align-items-center header-transparent bg-dark" >
    ...
    <input type="text" placeholder="Search Here..." id="search-box" name="mysearch" required style="padding:10px 15px;"> 
             <button type="submit" name="search" style="padding:10px 15px; background-color: #f39c12;"><i class="fas fa-search"></i> Search</button>
          </form></center>
           </div>
        <br>
        ...
        <div class="row">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="menu-flters">
              <a href="foodmenu.php"><li class="filter-active">Show All</li></a>
              <a href="kottu.php"><li>Kottu</li></a>
              <a href="Cheesekottu.php"><li>Cheese Kottu</li></a>
   ...
   <?php 
      include 'connection.php';
      $select_products = mysqli_query($con,"SELECT * FROM products ORDER BY(DATE) DESC");
   ...
   ?>
         ...
         <div class="box">
            ...
            <img src="updated_photo/<?php echo $fetch_prodcut['image']; ?>" class="image" alt="Food" >
