...
$id=$_GET['uid'];
$query=mysqli_query($con,"select * from special_menu where ID =$id ");

$productrow=mysqli_fetch_assoc($query);
$pname=$productrow['Name'];
$ptype=$productrow['Category'];
$pprice=$productrow['price'];
$pimage=$productrow['photo'];
...
if (isset($_POST['update'])) {
	...
	$updatesql=" update special_menu set Name='$xpname', Category='$menu_type', price='$xprice', photo='$p_image' where ID=$id ";
	$result=mysqli_query($con,$updatesql);

	if($result)
	{
        mysqli_query($con,"UPDATE products SET Product_Name='$xpname', Type='$menu_type' ,Price='$xprice' ,image='$p_image',DATE=now() WHERE Product_Name='$xpname' ");
  ...
  <!--Start Dashboard Content-->
   ...
   <div class="container align-items-center justify-content-center shadow-sm">
      ...
      <div class="col">
         <div class="card">
            <div class="card-body">
              <div class="card-title text-center"><h3>Update Special </h3></div>
